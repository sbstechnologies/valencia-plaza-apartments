...
import { ShieldCheck, Flame, Car, DoorOpen } from "lucide-react";
...
export default function Home() {
  ...
  const getAmenityIcon = (title = "", tag = "") => {
    ...
    // 10-Foot Ceilings / Open Layouts / Interior Living
    if (
    ...
    // Building Intercom / Security
    if (
      text.includes("intercom") ||
      text.includes("security") ||
      text.includes("entry system")
    ) {
    ...
    if (
      ...
      text.includes("interior comfort") ||
    ...
    if (
      ...
      text.includes("resident convenience")
    ) {
      return <WashingMachine className={iconClass} />;
    }

    // Covered / Reserved Parking
    if (text.includes("parking") || text.includes("covered parking")) {
    ...
    if (
      text.includes("foyer") ||
      text.includes("private living") ||
      text.includes("private entry")
    ) {
  ...
  const getAmenityDescription = (title = "") => {
    const descriptions: Record<string, string> = {
      "10-Foot Ceilings & Open Layouts":
        "Enjoy spacious interiors with 10-foot ceilings and open layouts designed for comfortable everyday living.",

      "Building Intercom Entry System":
        "Enjoy added convenience and peace of mind with a building intercom entry system for controlled resident access.",

      "Cozy In-Unit Fireplaces":
        "Relax at home with a cozy in-unit fireplace that adds warmth and comfort to your living space.",

      "Full Washer & Dryer Connections":
        "Enjoy everyday convenience with full washer and dryer connections available inside your apartment home.",

      "Reserved Covered Parking":
        "Enjoy convenient reserved covered parking that helps keep your vehicle protected and close to home.",

      "Semi-Private Entry Foyers":
        "Enjoy added privacy and a welcoming entrance with semi-private entry foyers designed for comfortable apartment living.",
    };
          ...
          >
            ...
            <div className="mb-8 flex items-center gap-4 w-full max-w-[900px] justify-center">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#F5F2ED]/50">
                Valencia Plaza PARK · FORT WORTH, TX · NOW LEASING
              </span>
              <div className="h-px flex-1 max-w-[72px] bg-[#F5F2ED]/15" />
            </div>
            ...
            <p className="text-[clamp(12px,1.3vw,15px)] leading-[1.55] text-[#F5F2ED]/70 mb-10 max-w-[800px]">
              An established community offering expansive 1,000 1,250 sq ft
              two-bedroom residences featuring semi-private foyers, upgraded
              interiors, and rapid connectivity to I 30 and Loop 820.
            </p>
