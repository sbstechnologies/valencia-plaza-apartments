  ...
  const getAmenityDescription = (title = "") => {
    const descriptions: Record<string, string> = {
      ...
      "Resident Clubhouse & Lounge":
        "Relax, gather, and connect with neighbors in the welcoming resident clubhouse and lounge at Valencia Plaza Apartments Homes.",
      ...
      "Laundry Facilities":
        "Enjoy added everyday convenience with on-site laundry facilities available within the Valencia Plaza Apartment Homes community.",
