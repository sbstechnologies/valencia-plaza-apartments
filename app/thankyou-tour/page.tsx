      ...
      <section className="relative overflow-hidden bg-[#1f376d] px-6 pt-32 pb-24 text-white sm:px-6 md:px-20 lg:px-40 xl:px-40 xxl:px-80">
        <div className="relative z-10 mx-auto max-w-[1920px]">
          ...
          <p className="mt-8 max-w-3xl font-[Plus_Jakarta_Sans] text-base leading-relaxed text-[#bfc6d6] md:text-lg">
            ...
            lease specials?
            <br /> Our dedicated easing team is here to help you find your
            perfect new home in East Fort Worth at Valencia Plaza.
          </p>
        </div>
      </section>
              ...
              <div className="px-6 py-10 text-center md:px-12 md:py-14">
                ...
                <div className="mt-6">
                  <p className="text-sm font-semibold text-gray-700 md:text-xl">
                    We look forward to showing you around Valencia Plaza Park !
                  </p>
